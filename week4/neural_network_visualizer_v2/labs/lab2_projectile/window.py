...
class Lab2Window(BaseLabWindow):
    ...
    def _build_custom_controls(self) -> QWidget:
        ...
        self._v0_lbl.setStyleSheet(_label_qss(COLORS["text_dim"], 9))
        ...
        self._theta_slider.setStyleSheet(_SLIDER_QSS)
    ...
    def _update_chart(self):
        ...
        ax.plot(x_true, y_true, color=COLORS["info"], linewidth=2,
                label=f"True (v₀={v0:.0f}, θ={theta:.0f}°)", alpha=0.9)
        ax.plot(x_pred, y_pred, color=COLORS["accent"], linewidth=1.8,
                linestyle="--", label="Predicted")
        ax.set_xlabel("x (m)", color=COLORS["text_dim"], fontfamily="Consolas")
        ax.set_ylabel("y (m)", color=COLORS["text_dim"], fontfamily="Consolas")
